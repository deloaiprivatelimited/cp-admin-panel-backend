...
from models.questions.rearrange import CollegeRearrange as Rearrange, TestRearrange, Item, Image
from models.test.section import Section, SectionQuestion

rearrange_bp = Blueprint("college_rearrange", __name__, url_prefix="/test/college-questions/rearranges")
