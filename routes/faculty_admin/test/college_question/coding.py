...
from models.questions.coding import CollegeQuestion as Question, TestQuestion, TestCaseGroup, TestCase  # if your module is models.py
...
coding_bp = Blueprint("college_coding", __name__, url_prefix="/test/college-questions/coding")
